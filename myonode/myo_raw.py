...
class MyoRaw(object):
    ...
    def connect(self):
        ...
        if self.old:
            # don't know what these do; Myo Connect sends them, though we get
            # data fine without them
            ...
            # Sampling rate of the underlying EMG sensor, capped to 1000. If
            # it's less than 1000, emg_hz is correct. If it is greater, the
            # actual framerate starts dropping inversely. Also, if this is much
            # less than 1000, EMG data becomes slower to respond to changes. In
            # conclusion, 1000 is probably a good value.
            C = 1000
            emg_hz = 50
...
if __name__ == '__main__':
    ...
    try:
        while True:
            m.run(1)  # Does this block or is it really iterable?
