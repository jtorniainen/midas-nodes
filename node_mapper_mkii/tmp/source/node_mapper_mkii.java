...
public class node_mapper_mkii extends PApplet {
...
public void draw_dispatcher(int y, String addr, boolean dispatcher_online)
{
  fill(255);
...
public JSONObject request_nodes(String addr)
{
  String[] request = loadStrings(addr + "status/nodes");
  return JSONObject.parse(join(request, "\n"));
}

public JSONObject request_node_info(String addr)
{
  return JSONObject.parse(join(loadStrings(addr + "/status/info"), "\n"));
}

public void draw_node(int x, int y, JSONObject node_status, String info_addr)
{
...
public void draw_data_source(int x, int y, JSONObject info)
{
  fill(255);
  rect(x, y, NODE_SIZE, NODE_SIZE);
  fill(0);
...
public String trim_string(String str)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "node_mapper_mkii" };
    if (passedArgs != null) {
